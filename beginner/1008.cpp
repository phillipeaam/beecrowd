...
int main()
{
	...
	int EmployeeNumber, HoursWorkedInAMonth;
	double SalaryPerHour;
	
	cin >> EmployeeNumber >> HoursWorkedInAMonth >> SalaryPerHour;

	double SalaryAtTheEndOfTheMonth = HoursWorkedInAMonth * SalaryPerHour;
	
	cout << "NUMBER = " << EmployeeNumber << endl;
	cout << "SALARY = U$ " << fixed << setprecision(Precision) << SalaryAtTheEndOfTheMonth << endl;

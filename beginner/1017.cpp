...
int main()
{
	...
	constexpr double km_per_liter = 12;
	
	int time_spent;
	double average_speed;

	cin >> time_spent >> average_speed;

	const double distance = time_spent * average_speed;
	const double fuel_spent = distance / km_per_liter;
	
	cout << fixed << setprecision(precision) << fuel_spent << endl;
